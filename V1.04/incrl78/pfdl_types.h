...
typedef   enum  {
                  ...
                  PFDL_ERR_PROTECTION           = (0x10),       /* 0x10, protection cError_Occured (access right conflict) */
                  PFDL_ERR_ERASE                = (0x1A),       /* 0x1A, erase cError_Occured                              */
                  PFDL_ERR_MARGIN               = (0x1B),       /* 0x1B, blankcheck or verify margin violated     */
                  PFDL_ERR_WRITE                = (0x1C),       /* 0x1C, write cError_Occured                              */
                  PFDL_ERR_PARAMETER            = (0x05)        /* 0x05, parameter cError_Occured                          */
                } pfdl_status_t;                                /* ---------------------------------------------- */
