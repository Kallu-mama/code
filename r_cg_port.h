...
#define DOORLOCK_ON P1.1 = 1
#define DOORLOCK_OFF P1.1 =0

#define PREWASH_VALVE_ON P1.5=1
#define PREWASH_VALVE_OFF P1.5=0

#define MAINWASH_VALVE_ON P5.1=1
#define MAINWASH_VALVE_OFF P5.1=0

#define DRAINPUMP_ON P1.7=1
#define DRAINPUMP_OFF P1.7=0

#define HEATER_ON P4.1 = 1
#define HEATER_OFF P4.1 = 0

#define C_B_PUMP_ON  P1.6=1
#define C_B_PUMP_OFF P1.6=0   

//*** WiFi Enable/Disable ***//

#define WIFI_SET_HIGH P1.3=1;
#define WIFI_SET_LOW  P1.3=0;

//******* Display ********//

#define ENCODER_VALUE P1 & 5


//STLED316S-IC-1
// if chip select =0 

#define  STB1_HIGH  P7.7=1;
#define  STB1_LOW  P7.7=0;

#define  CLK1_HIGH P7.6=1;
#define  CLK1_LOW P7.6=0;

#define  DATA1_OUT_HIGH P7.4=1;
#define  DATA1_OUT_LOW P7.4=0;

#define  DATA1 P7.4

#define  POWER_TOUCH_KEY P6.2  //NEO POWER KEY MICOM 

// if chip select =1

#define  STB_HIGH  P7.2=1;
#define  STB_LOW  P7.2=0;

#define  CLK_HIGH P7.3=1;
#define  CLK_LOW P7.3=0;

#define  DATA_OUT_HIGH P7.1=1;
#define  DATA_OUT_LOW P7.1=0;

#define  DATA P7.1

#define START_LED_ON P7.0=1; //0
#define START_LED_OFF P7.0=0; //1
